...
//   char *m = (char *)better_malloc(3000);
//   char *p = (char *)better_malloc(13000);  // cross page
//   // char *n = (char*)better_malloc(1000);
//   // char *q = (char*)better_malloc(1000);
...
//   better_free((void *)p);
//   // better_free((void *)p);
//   char *z = (char *)better_malloc(2000);
// //   char *k = (char *)better_malloc(3000);
// //   if(m != k)
// //   {
...
int main(void) {
  ...
  // printu("%llx   %llx",(uint64)p,(uint64)m);
  if((uint64)p - (uint64)m > 512 ){
    printu("you need to manage the vm space precisely!");
    exit(-1);
  }
